...
![Uma imagem contendo Linha do tempo](imagens/imagem_1.png)
...
![Figura 2 — Estrutura do Knowledge Graph temporal](../Documentos/imagens_tcc/fig2_fluxo_grafo.png)
...
![Figura 3 — Comparação de modelos GPT](imagens/imagem_2.png)
...
![Figura 4 — Métricas de polarização](imagens/imagem_3.png)
...
Os números da Tabela 1 sintetizam o processamento. Dos 100 comentários negativos escolhidos para o experimento, geraram-se 103 episódios (alguns comentários viram mais de um episódio ao extrair várias entidades). Foram identificadas 85 issues distintas. O fato de haver **91** arestas `Issue` ↔ `BusinessCapability` para **85** nós "issue" não indica erro de contagem: é evidência empírica de que o mesmo problema de usuário se ancora em mais de uma capacidade de negócio quando a falha é transversal — típico de serviços financeiros digitais, em que autenticação, segurança, interface e meios de pagamento se sobrepõem. Esse descompasso (mais relações do que issues únicas) é um achado útil para priorização: equipes de produto passam a ver explicitamente **onde** um mesmo sintoma exige coordenação entre áreas, e não apenas um "ticket" isolado. As issues se distribuem por 15 capacidades, sem tudo cair numa única categoria.
...
![Figura 6 — Distribuição por BusinessCapability](imagens/imagem_5.png)
...
![Figura 7 — Top 10 issues](imagens/imagem_6.png)
...
![Figura 8 — Distribuição por nível, tipo e valor de negócio](imagens/imagem_7.png)
...
![Figura 9 — Degree Centrality](imagens/imagem_8.png)
...
![Figura 10 — Métricas SNA combinadas](imagens/imagem_9.png)
...
Na modelagem do grafo, foram estabelecidos os seguintes relacionamentos: o episódio (comentário original) foi conectado à versão mencionada através de "HAS\_VERSION"; ambas as "Issues" foram vinculadas ao episódio através de "CONTAINS\_ENTITY"; "Não reconhece biometria" foi mapeada para "Login/Autenticação"; e "Inserir senha" foi associada tanto a "Login/Autenticação" quanto a "Segurança e Proteção".
...
BRYAN, J.; MORIANO, P. Graph-based machine learning improves just-in-time defect prediction. **PLoS ONE**, v. 18, n. 4, p. e0284077, 2023. Disponível em: https://doi.org/10.1371/journal.pone.0284077. Acesso em: 19 jan. 2026.
...
FEBRABAN. **Pesquisa FEBRABAN de Tecnologia Bancária 2025**. São Paulo: Federação Brasileira de Bancos, 2025. Disponível em: https://febrabantech.febraban.org.br. Acesso em: 19 jan. 2026.
...
LENARDUZZI, V.; BESKER, T.; TAIBI, D.; MARTINI, A.; ARCELLI FONTANA, F. Technical Debt Prioritization: State of the Art. A Systematic Literature Review. **arXiv preprint arXiv:1904.12538**, 2019. Disponível em: https://arxiv.org/abs/1904.12538. Acesso em: 19 jan. 2026.
...
ZHANG, J.; XIE, R.; YE, W.; ZHANG, Y.-H.; ZHANG, S.-K. Exploiting code knowledge graph for bug localization via bi-directional attention. In: **Proceedings of the 28th International Conference on Program Comprehension**. Seoul: ACM, 2020. p. 219-229. Disponível em: https://doi.org/10.1145/3387904.3389281. Acesso em: 19 jan. 2026.
