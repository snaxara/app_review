...
![Pipeline de processamento de avaliações, da coleta à geração de documentos de priorização](../Documentos/imagens_tcc/pipeline_processamento.png)
...
![Comparação de modelos GPT para extração e mapeamento](../Documentos/imagens_tcc/comparacao_modelos_gpt.png)
...
![Comparação de métricas entre DistilBERT Multilíngue e BERTweet](../Documentos/imagens_tcc/comparacao_modelos_sentimentos.png)
...
![Matrizes de confusão comparativas entre DistilBERT Multilíngue e BERTweet](../Documentos/imagens_tcc/matriz_confusao_sentimentos.png)
...
![Dez issues mais críticas por frequência de ocorrência](../Documentos/imagens_tcc/top_10_issues.png)
...
![Distribuição de Issues por nível hierárquico, tipo de capability e valor de negócio](../Documentos/imagens_tcc/distribuicao_nivel_tipo_valor.png)
