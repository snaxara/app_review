...
A sexta etapa do pipeline consolida um artefato de apoio ao comitê de backlog, com problemas ordenados por criticidade e conectados à versão do aplicativo e às BusinessCapabilities afetadas. Como proposta de consumo executivo, o relatório pode ser apresentado em formato de painel com ranking por categoria, impacto (frequência), severidade, prioridade e sprint sugerida, sem perder a rastreabilidade até o comentário original no grafo.

Na rodada piloto, foi gerado o relatório em Markdown `Documentos/backlog_priorizado.md`, com **200** avaliações negativas processadas em **02/12/2025** e modelo **GPT-4o**. A Figura 3 apresenta um modelo visual desse report executivo, com foco na leitura rápida para tomada de decisão em comitê de backlog. As análises quantitativas desta pesquisa permanecem baseadas no recorte principal de 100 comentários negativos do aplicativo CAIXA.
...
Figura 3. Relatório compacto de priorização de backlog, com metadados da execução e distribuição de categorias da rodada piloto (`backlog_priorizado.md`, 200 avaliações negativas, GPT-4o)
