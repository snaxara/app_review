...
def calculate_priorities(df):
    """Calcula as prioridades das categorias."""
...
def get_priority_level(priority_score):
    """Retorna o nível de prioridade com emoji."""
...
"""
    ...
    for category, priority in sorted_priorities:
        ...
        priority_emoji, priority_level = get_priority_level(priority)
        
        report += f"| {category} | {count} | {percentage:.1f}% | {severity:.2f}/5 | {priority_emoji} |\n"
...
"""
        ...
        # Adicionar até 3 exemplos de avaliações dessa categoria
...
def main():
    ...
    if 'functional_category' not in df.columns:
        print("✗ Erro: Coluna 'functional_category' não encontrada no CSV.")
